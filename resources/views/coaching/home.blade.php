            ...
            <div class="panel-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a
                                href="https://drive.google.com/open?id=1JvKM4-flbMZbowMpgM6HR3g-Mr-bBiKm8noBkQ4uJxc"
                                target="_blank">Planification saison</a></li>
                    <li class="list-group-item"><a
                                href="https://drive.google.com/open?id=0Bwg_0Xqlmx88T013aTlodzJiNjg"
                                target="_blank">Sideline inbound</a></li>
                </ul>
            </div>
        </div>
    </div>
