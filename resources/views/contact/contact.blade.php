...
@section('content')
    ...
    {{--<div class="spacing-margin"></div>--}}

    {{--<div class="row">--}}
    {{--<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">--}}
    {{--<div class="presentation-profil">--}}
    {{--<div class="photo-profil">--}}
    {{--<img src="{{asset("public/img/profil.jpg")}}" class="round-img">--}}
    {{--</div>--}}
    {{--<p>Dennis</p>--}}
    {{--<p>21 ans</p>--}}
    ...
    {{--<p><a>wdinnove@gmail.com</a></p>--}}
    {{--</div>--}}
    {{--</div>--}}

    {{--<div class="col-lg-8 col-sm-8 col-md-8 col-xs-12" style="padding-left: 70px;">--}}
    {{--<h1>CONTACTEZ-MOI</h1>--}}
